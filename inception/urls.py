...
#     url(r'^allworkflow/$', views.allworkflow, name='allworkflow'),
    ...
    url(r'^mainConfigList/$', views.mainConfigList, name='mainConfigList'),
    url(r'^addMainConfigForm/$', views.addMainConfigForm, name='addMainConfigForm'),
    url(r'^addMainConfig/$', views_ajax.addMainConfig, name='addMainConfig'),
    url(r'^delMainConfig/$', views_ajax.delMainConfig, name='delMainConfig'),
    url(r'^getMainConfigDetailInfo/$', views_ajax.getMainConfigDetailInfo, name='getMainConfigDetailInfo'), 
