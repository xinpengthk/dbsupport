...
from workflow.const import Const
from workflow.dao import Dao
from workflow.inception import InceptionDao
from workflow.models import users, workflow, master_config
from workflow.sendmail import MailSender
...
def autoreview(request):
    ...
    return HttpResponseRedirect('/workflow/detail/' + str(workflowId) + '/') 
